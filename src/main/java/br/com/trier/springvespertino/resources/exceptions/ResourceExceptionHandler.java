...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> getObjectNotFoundException(ObjectNotFound ex,
	...
	public ResponseEntity<StandardError> getIntegrityViolationException(IntegrityViolation ex,
			HttpServletRequest req){
